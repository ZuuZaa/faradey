...
import { UilArrowRight, UilCalender, UilStar, UilInfo, UilComparison  } from '@iconscout/react-unicons'
...
export default function MainPage() {
  ...
  async function fetchData(){
    ...
    params.append('LanguageID',lang_id);
      ...
      const response=await fetch(`http://89.40.2.200:3461/api/home/get-index?${params.toString()}`,{
        method: "GET",
        headers: {
        ...
        const res = await fetch("http://89.40.2.200:3461/api/cart/remove-from-cart", {
          ...
          for (let i = 0; i < min_plus_btns.length; i++) 
          {
            if(min_plus_btns[i].getAttribute('id')==cartid){
              ...
              newButton.id = prodid;
              newButton.className = 'rounded-full font-bold inline-block text-base add_cart_btn';
  ...
  return (
    <main className="flex flex-col items-center justify-between">
        ...
        <Swiper pagination={{ dynamicBullets: true, clickable:true }} loop={true} autoplay={{ delay: 5000, disableOnInteraction: false, }}  modules={[Pagination,Autoplay]} className="mySwiper" >
            {
                  ...
                  <SwiperSlide >
                    ...
                    <div className='content' >
                        <div className='frd-container mx-auto h-100'>
                          ...
                          <div>
                              <h4 className='text-xs md:text-2xl mb-1 md:mb-5'>{banner.title1}</h4>
                              <h1 className='text-lg md:text-4xl md:mb-6 font-semibold'>{banner.title2}</h1>
                              <p className='text-xs md:text-sm lg:text-lg'>{banner.description}</p>
                              
                              <Link href={"/category/" + banner.categoryId} className="link-design1 font-bold inline-flex rounded-full gap-1">{t('Shop Now')} <UilArrowRight size="24" color="#ffffff" /></Link>
                          </div>
  ...
        </section>
                    ...
                    categoryImages.map(catimg=>{
                      return(
                        <SwiperSlide className='zoom-img categories-swiper-item text-center'>
                          <Link href={"/category/" + catimg.id} key={catimg.id} passHref={true} className=''>
                            <div className='category-swiper-item-img-wrap w-full overflow-hidden'>
                              ...
                              <img src={catimg.image} width="300" height="400" class="blog-swiper-item-img object-cover w-full h-full mb-3" alt={catimg.name}></img>
                            </div>
        ...
        <section className='latest-products-section pb-6' >
          <div className='frd-container mx-auto mb-10'>
              <div className='flex justify-between items-center'>
                ...
                <Link href="products/3" className='section-title-link flex items-center'>{t('View all')} <UilArrowRight size="24" color="#e4573d" /></Link>
              </div>
            </div>
            <div className='frd-container mx-auto'>
              <Swiper 
        ...
                  </div>):(<div className='info-icon absolute '>
          ...
                    </div>)
                      ...
                      {
                        product.new==1?(<div className='new-product-icon absolute flex items-center justify-center'>{t('New')}</div>):(<div></div>)
                      }
  ...
        </section>
        ...
        <div className='frd-container mx-auto mb-10'>
              <div className='flex justify-between items-center'>
                ...
                <Link href='products/2' passHref={true}  className='section-title-link flex items-center'>{t('View all')} <UilArrowRight size="24" color="#e4573d" /></Link>
              </div>
            </div>
            <div className='frd-container mx-auto'>
              <Swiper 
        ...
        <section className='blog-events-section mt-5 mb-16'>
          <div className='frd-container mx-auto mb-10'>
              <div className='flex justify-between items-center'>
                  ...
                  <Link href='/blogs' className='section-title-link flex items-center'>{t('View all')} <UilArrowRight size="24" color="#e4573d" /></Link>
              </div>
          </div>
          <div className='frd-container mx-auto'>
                <Swiper
                    ...
                    blogs.map(blog=>{
                      return(
                        <SwiperSlide className='zoom-img blog-swiper-item' key={blog.id}>
                          <Link href={`blogs/${blog.id}`}  key={blog.id} passHref={true} className=''>
                          ...
                          <div className='blog-swiper-item-content pt-5'>
                            ...
                            <Link href={`blogs/${blog.id}`}  key={blog.id} passHref={true} className='name mt-2 text-xl tracking-normal hover-red block'>{blog.title}</Link>
                          </div>
                      </SwiperSlide>
