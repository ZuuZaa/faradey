...
import { UilPlusCircle, UilInfoCircle } from '@iconscout/react-unicons'
                        ...
                        <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                            ...
                            <li>
                                <div className="flex items-center">
                                    <a href="#" className="ms-1 text-sm font-medium md:ms-2">{t('Projects')}</a>
                                </div>
                            </li>
                                ...
                                <div className=''>
                                    <div className='account-projects-wrap'>
                                        <div className='title flex justify-between items-center border-b-2 mb-5'>
                                            <h2 className='text-lg leading-10'>{t('Projects')}</h2>
                                            <Link href="/account/projects/addproject"><UilPlusCircle size='23' className='cursor-pointer text-gray-800 hover:text-red-600'/></Link>
                                                    ...
                                                    <tbody>
                                                        {
                                                            projects.map(project=>{
                                                                const proj_status=[];
                                                            if(project.status==0){
                                                                proj_status.push(<Typography as="a" href="#" variant="small" color="blue-gray" className="font-medium">{t('Confirmed')}</Typography>)

                                                            }
                                                            else{
                                                                proj_status.push(<Typography as="a" href="#" variant="small" color="blue-gray" className="font-medium">{t('Not confirmed')}</Typography>)
                                                            }
                                                            return(
                                                            <tr key={project.id} className="even:bg-blue-gray-50/50">
                                                                <td className="p-4">
                                                                ...
                                                                <Typography as="a" href="#" variant="small" color="blue-gray" className="font-medium ">
                                                                    <Link href={"/account/projects/" + project.id}><UilInfoCircle size='23' className='cursor-pointer text-gray-800 hover:text-red-600'/></Link>
                                                                </Typography>
                                                                </td>
                                                            </tr>
                                                                )
