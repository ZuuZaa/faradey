...
export default function Header() {
  ...
  useEffect(() => {
    if (window.innerWidth > 1000) {
      function calcWidth() {
        var navwidth = 0;
        var otherwidth = $("header nav  ul.header-nav-ul .other").outerWidth(
          true
        );
        ...
        if (navwidth > availablespace) {
          var lastItem = $(
            "header nav  ul.header-nav-ul > li:not(.other)"
          ).last();
          lastItem.attr("data-width", lastItem.outerWidth(true));
          lastItem.prependTo($("header nav  ul.header-nav-ul .other ul"));
          calcWidth();
        } else {
          var firstOtherElement = $(
            "header nav  ul.header-nav-ul li.other li"
          ).first();
          if (navwidth + firstOtherElement.data("width") < availablespace) {
            firstOtherElement.insertBefore(
              $("header nav  ul.header-nav-ul .other")
            );
          }
        }
  ...
  return (
    <>
      ...
      <div
        className={`${
          show
            ? "close-mobile-offcanvas flex items-center justify-center active"
            : "close-mobile-offcanvas flex items-center justify-center"
        } `}
      ...
      >
        <FontAwesomeIcon
          icon={faTimes}
          color="#fff"
          className="mx-auto w-14 text-4xl"
        />
      </div>

      <header
        className={
          isScrolled ? "header-section-2 scrolled" : "header-section-2"
        }
      >
        <div className="frd-container mx-auto">
                  ...
                  <div className="header-lang">
                    <li className="relative">
                      ...
                      <ul className="header-lang-dropdown absolute top-full left-0 bg-white py-5 px-4">
                        <li className="flex items-center gap-2 mb-3 lang_btn">
                          <Image
                            src={FlagEng}
                            width={20}
                            height={20}
                            className="header-lang-flag rounded-full ml-2"
                            alt="Language"
                          />
                          EN
                        </li>
          ...
          <div>
            <div
              className={
                isScrolled ? "frd-container mx-auto" : "frd-container mx-auto"
              }
            >
              <div className="flex justify-between items-center py-2">
                ...
                <div className="extra flex gap-5 md:gap-6 items-center">
                  ...
                  <div
                    className={`${
                      show
                        ? "relative header-extra-mobile-menu-btn active flex items-center justify-center"
                        : "relative header-extra-mobile-menu-btn flex items-center justify-center"
                    } `}
                  ...
                  <ul className="header-nav-ul justify-center flex items-center mb-0 pl-0">
                    ...
                    <li className="nav-item hidden other dropdown">
                      ...
                      <div className="nav-dropdown">
                        <div className="nav-dropdown-2">
                          <ul className="nav-dropdown-ul"></ul>
                        </div>
                      </div>
                    </li>
                  </ul>
